...
def main():
   ...
   spark = SparkSession.builder\
      .appName("AWS RDS Redshift Read Write to S3/Hive") \
   ...
   drugs_df=getRdbmsPartData('/home/hduser/install/aws/connection_rds.prop',spark,'dev',drugs_query,"uniqueid",1,100,4)
   #healthcare.drugs
   drugs_df.show()
